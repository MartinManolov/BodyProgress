        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KcalPer100G = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TextContent = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    IsPublic = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodsMealsQuantities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FoodsMealsQuantities_Foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Foods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FoodsMealsQuantities_Meals_MealId",
                        column: x => x.MealId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodsMealsQuantities_FoodId",
                table: "FoodsMealsQuantities",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodsMealsQuantities_IsDeleted",
                table: "FoodsMealsQuantities",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_FoodsMealsQuantities_MealId",
                table: "FoodsMealsQuantities",
                column: "MealId");
